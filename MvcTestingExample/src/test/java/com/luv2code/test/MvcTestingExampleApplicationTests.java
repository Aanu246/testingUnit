...
class MvcTestingExampleApplicationTests {
	...
	@Test
	public void ddGradeResultsForStudentNotEquals() {
	...
	@DisplayName("Create student without grades innit")
	@Test
	public void createStudentWithoutGradesInit() {
		CollegeStudent studentTwo = context.getBean("colleeStudent",CollegeStudent.class);
	...
	public void findGradePointAverage() {
		assertAll("Testing all assertEquals", ()-> assertEquals(353.25, studentGrades.addGradeResultsForSingleClass(
				student.getStudentGrades().getMathGradeResults())), ()-> assertEquals(88.31, studentGrades.findGradePointAverage(
